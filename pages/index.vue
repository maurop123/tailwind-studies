<template>
    <div class="container mx-auto flex flex-wrap h-screen place-content-center grid grid-cols-1 bg-gradient-to-tr from-[#A30EA3] to-[#F0BD02] text-white text-drop-shadow">
        <div class="mx-auto">
            <img src="~/assets/github-profile-pic.jpeg"
